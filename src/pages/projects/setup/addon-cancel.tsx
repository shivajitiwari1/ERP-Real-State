...
export default function AddonCancelPage() {
  ...
  return (
    <div>
      <PageHeader title="Cancel Extra Add On Charge" />
        ...
        {projectId && (
          <div className="bg-white border rounded-lg shadow-sm overflow-hidden">
            <div className="bg-purple-700 px-3 py-2 text-white text-xs font-bold uppercase flex items-center justify-between">
              ...
              <span className="text-red-300 font-normal normal-case text-xs">Cancel / Deactivate Mode</span>
            </div>
