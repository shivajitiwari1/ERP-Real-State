            ...
            <div className="col-span-2">
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    <SelectPrimitive.Trigger className="flex h-7 w-full items-center justify-between border border-gray-300 bg-white px-2 text-xs rounded focus:outline-none">
