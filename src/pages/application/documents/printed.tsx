    ...
    <div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white border rounded-lg shadow-sm overflow-hidden">
          <div className="bg-purple-700 px-3 py-2 text-white text-xs font-bold uppercase">Printed Documents ({filtered.length} records)</div>
          <div className="overflow-auto">
            <table className="w-full text-xs">
              <thead><tr className="bg-slate-800 text-white"><th className="px-3 py-2">S.No.</th><th className="px-3 py-2">Reg. No.</th><th className="px-3 py-2">Customer Name</th><th className="px-3 py-2">Document</th><th className="px-3 py-2">Print Date</th><th className="px-3 py-2">Printed By</th><th className="px-3 py-2">Action</th></tr></thead>
              <tbody>
