      ...
      <div className="space-y-4">
        ...
        <div className="bg-white rounded border shadow-sm overflow-auto">
          <table className="w-full text-xs border-collapse">
            <thead><tr className="bg-purple-700 text-white">{['#','Customer','Reg. No.','Due Date','Days Overdue','Principal','Interest','Waiver'].map(h=><th key={h} className="px-2 py-2 text-left">{h}</th>)}</tr></thead>
