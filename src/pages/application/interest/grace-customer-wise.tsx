...
export default function GraceCustomerWisePage() {
  ...
  return (
    <div>
      <PageHeader title="Customer & Installment Wise Grace Period" />
      <div className="space-y-4">
        ...
        <div className="bg-white border rounded-lg shadow-sm overflow-hidden">
          <div className="bg-purple-700 px-3 py-2 text-white text-xs font-bold uppercase">Customer &amp; Installment Wise Grace Period ({withGrace.length} overdue)</div>
          <div className="overflow-auto">
            <table className="w-full text-xs">
              ...
              <tbody>
                ...
                withGrace.length === 0 ? <tr><td colSpan={10} className="text-center py-6 text-gray-400 italic">No overdue demands found</td></tr> :
